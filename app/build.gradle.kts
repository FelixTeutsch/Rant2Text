...
dependencies {
    ...
    //speechRecognition icon
//    implementation("andriodx.compose.material:material-icons-extended:2.3.1")
//    implementation("androidx.compose.material:material-icons-extended:2.3.1")
